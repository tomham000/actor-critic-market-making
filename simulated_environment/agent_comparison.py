...
fig.add_trace(go.Scatter(y=df['wealth'], mode='lines', name='cumulative reward', showlegend=True, line=dict(
    color='black',
    width=1)),
              secondary_y=True, )
