...
if __name__ == '__main__':
    ...
    eval_env = Monitor(
        MMEnvironmentBoxActions(debug=False, eval_env=True, algo_name=algo_name, data_path='./TSLA_clean_test_data.csv'))
    ...
    model = PPO('MlpPolicy', env, policy_kwargs=policy_kwargs, verbose=1, gamma=hyperparameters['gamma'],
